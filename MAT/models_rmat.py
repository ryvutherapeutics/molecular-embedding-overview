...
from MAT.models_api import PretrainedModelBase
from MAT.models_common_utils import *
from MAT.models_common_utils import Generator as mGenerator
from MAT.configuration_rmat import RMatConfig
from MAT.featurization_rmat import *
...
class RMatModel(PretrainedModelBase[RMatBatchEncoding, RMatConfig]):
    ...
    def __init__(self, config: RMatConfig):
        ...
        # models_common_utils.Generator
        self.generator = mGenerator(d_model=config.d_model,
